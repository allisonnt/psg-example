...
# De la siguiente tupla accede a los valores: 2, 4, 6

matrix = ((0, 1, 2), (3, 4, 5), (6, 7, 8))
print ("valor 2:", matrix[0][2])
print ("valor 2:", matrix[1][1])
print ("valor 6:", matrix[2][0])
...
cadenas = (("a", "es", "el", "progrmar"), ("estoy", "apre", "ar"), "ndiendo", "a")

cadena 1 = cadenas [1][0]
cadena 2 = cadenas [1][1]
